...
SOURCETYPE = "genesyscloud:usage:oauth_clients"
    ...
    for input_name, input_item in inputs.inputs.items():
        ...
        try:
            ...
            job_response = client.post(
                "UsageApi",
                "post_usage_client_aggregates_query_jobs",
            ...
            for attempt in range(MAX_POLL_ATTEMPTS):
                ...
                status_response = client.get(
                    "UsageApi", "get_usage_client_aggregates_query_jobs_results",
                    job_id=job_id,
                    client_id=target_client_id,
                )
                if status_response:
                ...
                logger.warning(f"OAuth client usage job {job_id} did not complete within {MAX_POLL_ATTEMPTS * POLL_INTERVAL_SECONDS}s")
